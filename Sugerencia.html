...
<body>
    ...
    <form action="https://formsubmit.co/romeolunavictoria1985@gmail.com" method="POST" class="formsubmit">
        <fieldset>
    
    <label for="name">Nombre</label>
    <br>
    <input type="text" name="name" id="name" class="controls" required>  
    <br>
    <label for="email">Correo electronico</label>
    <br>
    <input type="email" name="email" id="email" class="controls" required>
    <br>
    <label for="subject">Asunto</label>
    <br>
    <input type="text" name="subject" id="subject" class="controls" required>
    <br>
    <label for="text">Sugerencias</label>
<br>
<textarea name="text" id="text" class="Castroselacome"></textarea>
